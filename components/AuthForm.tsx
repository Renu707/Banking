    ...
    try {
       ...
       if(type === 'sign-up') {
        ...
        const newUser = await signUp(data);
          ...
          setUser(newUser);  // Ensure user state is updated
    ...
    <section className='auth-form'>
        ...
        <div className='flex flex-col gap-1 md:gap-3'>
            ...
            <p className='text-16 font-normal text-gray-600'>
                {
                    user ?
                    'Link your account to Horizon':'please enter your details '
                }
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        />
         ...
         <CustomInput  
        control={form.control }name='address1'label='Address' placeholder='enter your specfic address'
        />
         <CustomInput  
...
<div className='flex gap-4'>
        ...
        />
         <CustomInput  
        control={form.control }name='postalCode'label='Postal Code' placeholder='Example:572102'
        />
...
<div className='flex gap-4'>
  ...
  {isLoading ? (
    ...
    <p className=' text-14 font-normak text-gray-600'>   
      {
        type ==='sign-in' ?
